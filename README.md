...
| Move Negative | `MVN rdest src` | Wie `MOV`, nur wird hier der Wert negiert | `0000 0001` |
...
| Move Float | `MVF rdest src` | Kopiert einen Float Wert von `src` nach `rdest` | `0000 1010` |
...
| Load to Register | `LDR reg, [MEM, offset]` | Lädt den im Speicher befindlichen Wert in das Register.  | `0001 0011` |
| Store to Memory from Register | `STR reg, [MEM, offset]` | Speichert den im Register befindlichen Wert in den Speicher | `0001 0100` |
